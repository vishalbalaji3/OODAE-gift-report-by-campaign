...
create_filter_manager <- function(full_data) {
  ...
  manager <- list(
    ...
    apply_filters = function(campaign = NULL, gift_types = NULL,
                           years = NULL, timeframe = "fiscal") {
      data <- data_source
    ...
    calculate_summary_stats = function(filtered_data) {
      ...
      list(
        ...
        avg_gift_size = sum(filtered_data$`Fund Split Amount`, na.rm = TRUE) /
          nrow(filtered_data)
      )
    },
  ...
  manager$create_reactive_available_years <- function(input,
                                                     context = "tables") {
    reactive({
  ...
  manager$create_reactive_fiscal_years <- function(filtered_data_reactive,
...
create_filter_context <- function(filter_manager, input, context = "tables") {
  list(
    ...
    available_years = filter_manager$create_reactive_available_years(input,
                                                                    context),
